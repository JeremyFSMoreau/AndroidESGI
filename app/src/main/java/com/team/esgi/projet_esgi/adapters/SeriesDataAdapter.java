...
public class SeriesDataAdapter extends ArrayAdapter<Serie> {

    public SeriesDataAdapter(ArrayList<Serie> dataSeries, Context context) {
        super(context, 0, dataSeries);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text.setText(serie.getDataSerie().getSeriesName());
        return convertView;
    }
}